...
- [トークン](#%E3%83%88%E3%83%BC%E3%82%AF%E3%83%B3)
  ...
  - [1行コメント `// comment` `# comment`](#1%E8%A1%8C%E3%82%B3%E3%83%A1%E3%83%B3%E3%83%88--comment--comment)
  - [ブロックコメント `/* comment */`](#%E3%83%96%E3%83%AD%E3%83%83%E3%82%AF%E3%82%B3%E3%83%A1%E3%83%B3%E3%83%88--comment-)
  - [入れ子ブロックコメント `/+++++ comment +++++/`](#%E5%85%A5%E3%82%8C%E5%AD%90%E3%83%96%E3%83%AD%E3%83%83%E3%82%AF%E3%82%B3%E3%83%A1%E3%83%B3%E3%83%88--comment-)
- [演算子](#%E6%BC%94%E7%AE%97%E5%AD%90)
  ...
  - [代入 `var = val`](#%E4%BB%A3%E5%85%A5-var--val)
    - [オブジェクトプロパティへの代入](#%E3%82%AA%E3%83%96%E3%82%B8%E3%82%A7%E3%82%AF%E3%83%88%E3%83%97%E3%83%AD%E3%83%91%E3%83%86%E3%82%A3%E3%81%B8%E3%81%AE%E4%BB%A3%E5%85%A5)
    - [配列要素への代入](#%E9%85%8D%E5%88%97%E8%A6%81%E7%B4%A0%E3%81%B8%E3%81%AE%E4%BB%A3%E5%85%A5)
...
- [stdライブラリ](#std%E3%83%A9%E3%82%A4%E3%83%96%E3%83%A9%E3%83%AA)
  - [`JOIN[stream[; delimiter]]`関数](#joinstream-delimiter%E9%96%A2%E6%95%B0)
  - [`SPLIT[string[; delimiter]]`関数](#splitstring-delimiter%E9%96%A2%E6%95%B0)
...
## 1行コメント `// comment` `# comment`

2種類のコメントがあり、どちらも行末までをコメントアウトします。
...
`//`はプログラムコードのコメントアウトに、`#`は説明の記入に使用することが推奨されています。

----

ファイル先頭行の`#!`コメントはShebangの記述に利用できます。
...
`/+` `+/`で囲むと入れ子ブロックコメントになります。
開始と終了の`+`は5個まで連続して記述でき、それより少ない個数の`+`による終端を無視します。
...
`+`の個数が同一の入れ子ブロックコメントは入れ子に書くことができます。
...
配列要素に代入を行うことができます。
配列の長さを超えたインデックスに対して代入を行うと、その間はUNDEFINEDで補充されます。
...
`string`を改行付きで出力します。
`string`がストリームであった場合は、要素を1個ずつ出力します。
